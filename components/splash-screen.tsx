    ...
    <AnimatePresence>
      {show && (
        <motion.div
          ...
          className="fixed inset-0 z-[200] flex flex-col items-center justify-center bg-[#f8f7f4] overflow-hidden"
        >
          {/* Curva amarilla arriba izquierda */}
          <div className="absolute top-0 left-0 w-[60%] h-[25%]">
            <svg viewBox="0 0 100 100" preserveAspectRatio="none" className="w-full h-full">
              <path
                d="M0,0 L0,100 Q50,80 100,0 Z"
                fill="#f5c518"
              />
            </svg>
          </div>
          ...
          <div className="absolute bottom-0 right-0 w-[50%] h-[20%]">
            <svg viewBox="0 0 100 100" preserveAspectRatio="none" className="w-full h-full">
              <path
                d="M100,100 L100,0 Q50,20 0,100 Z"
                fill="#4caf50"
              />
            </svg>
          </div>
